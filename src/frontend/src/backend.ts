...
export class Backend implements backendInterface {
    ...
    async getDay(arg0: bigint): Promise<Day> {
        if (this.processError) {
            try {
    ...
    async getDaysRange(arg0: bigint, arg1: bigint): Promise<Array<Day>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDaysRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyProgress(): Promise<DailyProgress> {
        if (this.processError) {
            try {
    ...
    async getProgramStats(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getProgramStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markDayComplete(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async resetMyProgress(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetMyProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
